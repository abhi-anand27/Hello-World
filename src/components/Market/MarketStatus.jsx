...
import { TrendingUp, Activity, Globe, Tv, Megaphone, Smartphone } from 'lucide-react'
...
const SRC = ({ text }) => (
  <p className="text-xs text-gray-600 mt-2">Source: {text}</p>
)

// format ₹ Cr with Indian comma notation
function fmtCr(v) {
  if (v >= 100000) return `₹${(v / 100000).toFixed(2)} lakh Cr`
  if (v >= 1000) return `₹${v.toLocaleString('en-IN')} Cr`
  return `₹${v} Cr`
}
    ...
    <div className="space-y-6 max-w-screen-xl">
      <div>
        ...
        <p className="text-sm text-gray-400 mt-0.5">
          ...
          <span className="text-gray-300">FICCI-EY 2026 report</span>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
        {[
          { label: 'Total M&E Sector (2025)', value: '₹2,78,500 Cr', sub: 'US$32 Bn (~0.8% GDP)', growth: `+${meOverview.growth2025}%`, icon: TrendingUp },
          { label: 'Digital Media (2025)',    value: '₹1,11,000 Cr', sub: '1st segment to cross ₹1 lakh Cr', growth: '+30.5%', icon: Globe },
          { label: 'Television (2025)',       value: '₹61,700 Cr',   sub: '2nd largest segment', growth: `${tvMetrics.linearRevGrowth}%`, icon: Tv },
          { label: 'Total Advertising (2025)',value: '₹1,50,400 Cr', sub: `Digital ${adMarketOverview.digitalShare2025}% share`, growth: `+${adMarketOverview.growth2025}%`, icon: Megaphone },
      ...
      <p className="text-xs text-gray-600 -mt-2">Source: FICCI-EY 2026, p.11–12. All figures in INR Crores, gross of taxes, calendar years. EY estimates.</p>
      ...
      {tab === 'M&E Industry' && (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          ...
          <div className="card lg:col-span-2 overflow-x-auto">
            ...
            <SRC text="FICCI-EY 2026, p.12. ~0.8% of India's GDP; 2.75M direct jobs, 10M indirect jobs." />
          </div>
        </div>
      )}
      ...
      {tab === 'Television' && (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          ...
          <div className="card lg:col-span-2">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              {[
                ...
                { l: 'Subscription revenue', v: `${tvMetrics.subRevGrowth}%`, s: `−${tvMetrics.payTvLossMn}M Pay TV HH lost`, neg: true },
            ...
            <SRC text="FICCI-EY 2026, p.66–67. BARC viewership data." />
          </div>
          ...
          <div className="card lg:col-span-2 overflow-x-auto">
            ...
            <SRC text="FICCI-EY 2026, p.67. Television CAGR 2025–28: −5%." />
          </div>
        </div>
      )}
      ...
      {tab === 'Digital' && (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          ...
          <div className="card">
            ...
            <SRC text="FICCI-EY 2026, p.31–32" />
          </div>
          ...
          <div className="card lg:col-span-2">
            ...
            <SRC text="FICCI-EY 2026, p.30–32" />
          </div>
          ...
          <div className="card lg:col-span-2">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              {[
                ...
                { l: 'Sports/Ent OTT ads', v: `+${vodMetrics.sportsOTTAdGrowth || 34}%`, s: 'sports & entertainment OTT ad rev', ...(vodMetrics.sportsOTTAdGrowth && {}) },
            ...
            <SRC text="FICCI-EY 2026, p.32–33. JioHotstar IPL 2025 data." />
          </div>

          {/* Digital Traffic / Online video */}
          <div className="card">
            ...
            <SRC text="FICCI-EY 2026, p.37–39. Sensor Tower, BARC." />
          </div>

          {/* App / Device / CTV metrics */}
          <div className="card">
            ...
            <SRC text="FICCI-EY 2026, p.35–36. Sensor Tower State of Mobile 2026; TRAI; Ericsson Mobility Report." />
          </div>
          ...
          <div className="card lg:col-span-2 overflow-x-auto">
            ...
            <SRC text="FICCI-EY 2026, p.30. Digital media CAGR 2025–28: +14%." />
          </div>
        </div>
      )}
      ...
      {tab === 'Advertising' && (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          ...
          <div className="card lg:col-span-2 overflow-x-auto">
            ...
            <SRC text={`FICCI-EY 2026, p.234. Digital share of total ad: ${adMarketOverview.digitalShare2024}% (2024) → ${adMarketOverview.digitalShare2025}% (2025).`} />
          </div>
        </div>
      )}
      ...
      {tab === 'Forecasts' && (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          <div className="card lg:col-span-2">
            ...
            <SRC text="FICCI-EY 2026, p.12. EY estimates." />
          </div>
          <div className="card">
          ...
          <div className="card lg:col-span-2">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              {[
                ...
                { l: 'Digital subs 2028E', v: `₹${vodMetrics.videoSubRev2028ECr.toLocaleString('en-IN')} Cr`, s: 'video OTT subscriptions' },
            ...
            <SRC text="FICCI-EY 2026, p.11–12, 30–33. All projections are EY estimates, INR Crores, gross of taxes." />
          </div>
        </div>
      )}
    </div>
